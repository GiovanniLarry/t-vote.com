    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('feedbconfig.php');
					...
					if(isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["message"]))
					{
       ...
       $DB_NAME="feedback_db";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO feedback_db.feedb_td VALUES(null,'".$name."','".$email."','".$message."');";
					

				if(mysqli_query($conn, $sql)){
					echo "<img src='images/change.png' width='90' height='70'>";
					echo "<h3 class='text-info specialHead text-center'><strong> FEEDBACK  SENT  SUCCESSFULLY.</strong></h3>";
				...
				else
				{
					...
					echo "<h3 class='text-info specialHead text-center'><strong> SORRY! AN ERROR OCCURED..</strong></h3>";
					echo "<a href='index.html' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Finish</strong> </a>";
				}
